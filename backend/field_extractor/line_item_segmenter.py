...
# 2026-09-02 校准: 边界0(项目名称→单价) "称"右沿+10px 导致项目名称末尾字被切
#   例如 '*交通运输服务*客运服务费' 中 '费' 被切到单价列
#   OCR 缓存量化: 称右沿≈283.9, 明细项名右沿≈343.3, 差≈59px, 留+30安全边距
#   边界1-4 暂无样本暴露问题, 保持 0
_COL_BOUNDARY_ADJUSTMENTS_6COL = [30.0, 0.0, 0.0, 0.0, 0.0]
